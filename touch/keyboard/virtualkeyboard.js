;var VirtualKeyboard=new function()
{
	...
	var _=true;
	var c=true;
	var C={14:'backspace',15:'tab',28:'enter',29:'caps',41:'shift_left',52:'shift_right',53:'del',54:'ctrl_left',55:'alt_left',56:'space',57:'alt_right',58:'ctrl_right'};
	var v={'SHIFT':'shift','ALT':'alt','CTRL':'ctrl','CAPS':'caps'};
	var V;
	var x={'QWERTY Default':"À1234567890m=ÜQWERTYUIOPÛÝASDFGHJKL;ÞZXCVBNM¼¾¿",'QWERTY Canadian':"Þ1234567890m=ÜQWERTYUIOPÛÝASDFGHJKL;ÀZXCVBNM¼¾¿",
		   'QWERTY Dutch':"Þ1234567890Û¿ÜQWERTYUIOPÝ;ASDFGHJKL=ÀZXCVBNM¼¾m",'QWERTY Estonian':"¿1234567890m=ÜQWERTYUIOPÞÛASDFGHJKL;ÀZXCVBNM¼¾Ý",
		   'QWERTY Greek (220)':"À1234567890¿ÛÜQWERTYUIOP=ÝASDFGHJKL;ÞZXCVBNM¼¾m",'QWERTY Greek (319)':"À1234567890¿=ÜQWERTYUIOPÛÝASDFGHJKL;ÞZXCVBNM¼¾m",
		   'QWERTY Gujarati':"À1234567890m=XQWERTYUIOPÛÝASDFGHJKL;ÜZXCVBNM¼¾¿",'QWERTY Italian':"Ü1234567890ÛÝ¿QWERTYUIOP;=ASDFGHJKLÀÞZXCVBNM¼¾m",
		   'QWERTY Kannada':"À1234567890m=ZQWERTYUIOPÛÝASDFGHJKL;ÞZXCVBNM¼¾¿",'QWERTY Portuguese':"À1234567890ÛÝ¿QWERTYUIOP=;ASDFGHJKLÞÜZXCVBNM¼¾m",
		   'QWERTY Scandinavian':"Ü1234567890=Û¿QWERTYUIOPÝ;ASDFGHJKLÀÞZXCVBNM¼¾m",'QWERTY Spanish':"Ü1234567890mÛ¿QWERTYUIOPÝ;ASDFGHJKLÀÞZXCVBNM¼¾ß",
		   'QWERTY Tamil':"À1234567890m =ZQWERTYUIOPÛÝASDFGHJKL;ÞCVBNM¼¾ ¿",'QWERTY Turkish':"À1234567890ßm¼QWERTYUIOPÛÝASDFGHJKL;ÞZXCVBNM¿Ü¾",
		   'QWERTY UK':"ß1234567890m=ÞQWERTYUIOPÛÝASDFGHJKL;ÀZXCVBNM¼¾¿",'QWERTZ Albanian':"À1234567890m=ÜQWERTZUIOPÛÝASDFGHJKL;ÞYXCVBNM¼¾¿",
		   'QWERTZ Bosnian':"À1234567890¿=ÜQWERTZUIOPÛÝASDFGHJKL;ÞYXCVBNM¼¾m",'QWERTZ Czech':"À1234567890=¿ÜQWERTZUIOPÛÝASDFGHJKL;ÞYXCVBNM¼¾m",
		   'QWERTZ German':"Ü1234567890ÛÝ¿QWERTZUIOP;=ASDFGHJKLÀÞYXCVBNM¼¾m",'QWERTZ Hungarian':"0123456789À¿=ÜQWERTZUIOPÛÝASDFGHJKL;ÞYXCVBNM¼¾m",
		   'QWERTZ Slovak':"À1234567890¿ßÜQWERTZUIOPÛÝASDFGHJKL;ÞYXCVBNM¼¾m",'QWERTZ Swiss':"Ü1234567890ÛÝßQWERTZUIOP;ÞASDFGHJKLÀ¿YXCVBNM¼¾m",
		   'AZERTY Belgian':"Þ1234567890ÛmÜAZERTYUIOPÝ;QSDFGHJKLMÀWXCVBN¼¾¿=",'AZERTY French':"Þ1234567890Û=ÜAZERTYUIOPÝ;QSDFGHJKLMÀWXCVBN¼¾¿ß",
		   ',WERTY Bulgarian':"À1234567890m¾Ü¼WERTYUIOPÛÝASDFGHJKL;ÞZXCVBNMßQ¿",'QGJRMV Latvian':"À1234567890mFÜQGJRMVNZWXYH;USILDATECÞÛBÝKPOß¼¾¿",
			'/,.PYF UK-Dvorak':"m1234567890ÛÝÜÀ¼¾PYFGCRL¿=AOEUIDHTNSÞ;QJKXBMWVZ",'FG;IOD Turkish F':"À1234567890=mXFG;IODRNHPQWUÛEAÝTKMLYÞJÜVC¿ZSB¾¼",
			';QBYUR US-Dvorak':"7ÛÝ¿PFMLJ4321Ü;QBYURSO¾65=mKCDTHEAZ8ÞÀXGVWNI¼09",'56Q.OR US-Dvorak':"m1234JLMFP¿ÛÝÜ56Q¾ORSUYB;=78ZAEHTDCKÞ90X¼INWVGÀ"};
	var X=0,z=0,Z=1,w=2,W=4,s=8,S=W|s,k=W|Z,K=w|s,q=w|W,E=w|W|s,r=w|Z,R=Z|w|W,t=Z|s,T=Z|w|W|s;
	var y={'buttonUp':'kbButton','buttonDown':'kbButtonDown','buttonHover':'kbButtonHover','hoverShift':'hoverShift','hoverAlt':'hoverAlt','modeAlt':'modeAlt',
			'modeAltCaps':'modeAltCaps','modeCaps':'modeCaps','modeNormal':'modeNormal','modeShift':'modeShift','modeShiftAlt':'modeShiftAlt',
			'modeShiftAltCaps':'modeShiftAltCaps','modeShiftCaps':'modeShiftCaps','charNormal':'charNormal','charShift':'charShift','charAlt':'charAlt',
			'charShiftAlt':'charShiftAlt','charCaps':'charCaps','charShiftCaps':'charShiftCaps','hiddenAlt':'hiddenAlt','hiddenCaps':'hiddenCaps',
			'hiddenShift':'hiddenShift','hiddenShiftCaps':'hiddenShiftCaps','deadkey':'deadKey','noanim':'VK_no_animate'};
	var Y=null;
	var u=[];
	u.hash={};
	u.codes={};
	...
	I.addLayout=function(i)
	{
		...
		if(u.hash.hasOwnProperty(i.id)){
			...
			i.toString=function(){return this.id};
			u.options=null
		}
	};
	...
	var a=function(i){
		...
		switch(i.type){
			case'keydown':	
				switch(iI){	
					case 9:break;
					case 37:if(I.IME.isOpen()){
								I.IME.prevPage(i);
								i.preventDefault();
							}
							break;
					case 39:if(I.IME.isOpen()){
								I.IME.nextPage(i);
								i.preventDefault();
							}
							break;
					case 38:if(I.IME.isOpen()){
							if(!I.IME.showPaged())
								I.IME.prevPage(i);
								i.preventDefault();
							}
							break;
					case 40:if(I.IME.isOpen()){	
							...
							break;
					case 8:	
					case 46:var il=U.desk.childNodes[V[iI]];
							if(_&&!i.getRepeat())
								DOM.CSS(il).addClass(y.buttonDown);
							if(!P(il.id,i))
								i.preventDefault();
							break;
					case 20:if(!i.getRepeat()){
							e=e^s
							}
							break;
					case 27:if(I.IME.isOpen()){
							I.IME.hide();
							}
							else{
			...
			case'keyup':
					...
					break;
			case'keypress':if(p&&!i.VK_bypass){
								if(!P(p,i)){
									i.stopPropagation();
									i.preventDefault();
								}
	...
	var d=function(i){
		...
		switch(il){
			case"caps":iI=iI^s;
				break;
			case"shift_left":
			case"shift_right":if(i.shiftKey)
							break;
							iI=iI^Z;
							break;
			case"alt_left":
			case"alt_right":
			case"ctrl_left":
			case"ctrl_right":iI=iI^(i.altKey<<1^w)^(i.ctrlKey<<2^W);
							break;
			default:if(_)
...
//		I.open(i);
	...
	I.detachInput=function(){
		...
		if(U.attachedInput){
			...
			var e=document.body.parentNode;EM.removeEventListener(e,'keydown',a);
	...
	I.open=I.show=function(i,e){
		...
		if(!U.keyboard.parentNode||U.keyboard.parentNode.nodeType==11){
			if(isString(e)){
				...
				document.body.appendChild(U.keyboard);
			}		
		}
		return true
	};
	...
	I.isEnabled=function(){return c};
	I.isReady=function(){return u.length>0};
	var F=function(i,e){
	...
	var L=function(i){
		var e=i.normal,
			...
			i_=i.dk,
			ic=i.cbk,
			iC,ie,iv,iV,ix=null,iX,iz,iZ,iw,iW=-1,is=[];
	...
	var n=function(i,e){
		...
		switch(0+i){
			case 0:iI.className=DOM.CSS(il).removeClass(y.buttonDown).getClass();
				break;
			case 1:DOM.CSS(U.desk).removeClass([y.hoverShift,y.hoverAlt]);
				iI.className=DOM.CSS(il).addClass(y.buttonDown).getClass();
				break;
			case 2:if(v.SHIFT==e&&X&Z^Z){
	...
	var N=function(i,e,iI){
		...
		if(il){
			switch(0+i){
				case 0:DOM.CSS(il).removeClass(y.buttonDown);
					break;
				case 1:DOM.CSS(il).addClass(y.buttonDown);
					break;
				case 2:DOM.CSS(il).addClass(y.buttonHover);
					break;
				case 3:DOM.CSS(il).removeClass(y.buttonHover);
					break
			}
		}
	};
	...
	(function(){
		...
		U.keyboard.innerHTML=("<div id=\"kbDesk\"><!-- --></div>"+"<div class=\"progressbar\"><!-- --></div>"+"<select id=\"kb_langselector\"></select>"+
							  "<select id=\"kb_mappingselector\"></select>"+'<div id="copyrights" nofocus="true"><a href="http://debugger.ru/projects/virtualkeyboard" target="_blank" title="&copy;2006-2009 Debugger.ru">VirtualKeyboard '+
		...
		EM.addEventListener(i,'change',function(e){I.switchLayout(this.value)});
		U.langbox=i;
		...
		if(!x.hasOwnProperty(V))
			V='QWERTY Default';
		for(var il in x){
			var io=x[il].split("").map(function(e){return e.charCodeAt(0)});
			io.splice(14,0,8,9);
		...
		O.layout=iV.vk_layout||iv.vk_layout||DocumentCookie.get('vk_layout')||O.layout;O.skin=iV.vk_skin||iv.vk_skin||O.skin;
		h(true);
	})();
};
...
VirtualKeyboard.IME=new function(){
	...
	i.hide=function(x){
		if(l&&'none'!=l.style.display){
			...
			if(c&&DocumentSelection.getSelection(c)&&!x)DocumentSelection.deleteSelection(c);c=null;_=[]}};
			i.updatePosition=function(){
				var x=DOM.getOffset(c);
				l.style.left=x.x+'px';
				var X=DocumentSelection.getSelectionOffset(c);l.style.top=x.y+X.y+X.h-c.scrollTop+'px'
			};
			...
			i.nextPage=function(x){
				O=Math.max(Math.min(O+1,(Math.ceil(_.length/10))-1),0);e();
			};
			i.prevPage=function(x){
				O=Math.max(O-1,0);
				e();
			};
			i.getPage=function(){return O};
			i.getChar=function(x){
				x=--x<0?9:x;return _[i.getPage()*10+x]
			};
			i.isOpen=function(){
