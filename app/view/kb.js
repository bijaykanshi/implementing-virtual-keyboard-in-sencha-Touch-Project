...
//				  if (ex.className.indexOf("keyboardInput") > -1)
  ...
  this.VKI_show = function(elem) {
    if (!this.VKI_target) {
      ...
      this.VKI_position(false);
      if (self.VKI_isMoz || self.VKI_isWebKit) this.VKI_position(false);
  ...
  this.VKI_position = function(force) {
    if (self.VKI_target) {
      ...
      if (place || force === true) {
        var iPos = VKI_findPos(self.VKI_keyboard), scr = self.VKI_target;
        ...
        self.VKI_keyboard.style.top = iPos[1]-50 /*((self.VKI_target.keyboardPosition == "fixed" && !self.VKI_isIE && !self.VKI_isMoz) ? sDis[1] : 0) + fudge*/ + "px";
  ...
  function VKI_findPos(obj) {
   /* var curleft = curtop = 0, scr = obj;
	...
	return [200,300];*/
      parentDimension = VKI_innerDimensions();
      var left = (parentDimension[0]- obj.clientWidth)/ 2,
          top = (parentDimension[1] - obj.clientHeight);
      return [left,top];
  }
